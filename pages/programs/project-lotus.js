    ...
    <div className="max-h-full text-black">
      ...
      <section class="text-gray-600 body-font bg-gradient-to-r from-rose-200 via-indigo-200 to-teal-100 animate-gradient-x">
        <div class="max-w-5xl pt-52 pb-40 mx-auto">
          <h3 class="text-2xl text-center font-extrabold leading-tight">
            Support Group
          </h3>
          <h1 className="mt-8 text-5xl font-black leading-tight text-gray-800">
            Create your own{' '}
            <div className="relative inline-block">
              <span className="relative z-10">support</span>
              <div className="absolute bottom-0 left-1.5 right-0 h-4">
                <img
                  className="-mt-1"
            ...
            <span className="font-black text-brand-pink">.</span>
          </h1>
          ...
          <div className="flex items-center justify-center">
            <a
              className="inline-block px-5 py-3 py-6 pl-8 pr-6 mt-2 mt-16 text-sm font-semibold tracking-wider text-white uppercase bg-gray-800 rounded-md shadow focus:outline-none focus:shadow-outline hover:bg-gray-700 active:bg-gray-600"
              href="/get-started"
            >

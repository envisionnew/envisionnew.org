...
On **_March 6th, 2020_**, we suspended Project enVision operations at all locations and recommended that volunteers to stay home. Only Project enVision Inspire programs were active during this time.

On **_March 9th, 2020_**, Project enVision sent recommendations to California Governor Gavin Newsom, California State Superintendent Tony Thurmond, and school districts regarding the impact of COVID-19 on local and educational services and concerns.

On **_March 19th, 2020_**, Project enVision complied with California's Stay at Home Order and required all incubated nonprofits through Project enVision Inspire to suspend direct operations indefinitely.
...
We hope you and your family stay safe. If I can be of any help, please don't hesitate to reach out to me via email ([rushil@envisionnew.org](https://blog.envisionnew.org/how-project-envision-is-helping-during-covid-19/rushil@envisionnew.org)).
